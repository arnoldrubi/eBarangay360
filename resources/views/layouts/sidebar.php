...
<nav id="sidebar" class="col-md-2 d-none d-md-block sidebar py-3 px-2">
  ...
  <ul class="nav flex-column">
    <ul class="nav flex-column">
      <li class="nav-item mb-2"><a href="?page=logout" class="nav-link"><i class="material-symbols-outlined md-18">logout</i>Logout</a></li>
      <li class="nav-item mb-2"><a href="?page=manage-account" class="nav-link <?php echo $page === 'manage-account' ? 'active' : ''; ?>"><i class="material-symbols-outlined md-18">manage_accounts</i>Manage My Account</a></li>
    </ul>
    <?php    
