<?php
  ...
  if(isset($_GET['request_id']) && $_GET['success'] == 1) {
     ...
     $stmt = $pdo->prepare("
       ...
       FROM residents r
       JOIN barangay_indigency_requests bcr ON r.id = bcr.resident_id
     ...
     if ($request) {
        ...
        // fix the date of birth in this format Month Day, Yea
        // set variables
        ...
        $requester_date_of_birth = date("F j, Y", strtotime($request['date_of_birth']));
...
<main id="residents-dashboard" class="col-md-10 ms-sm-auto px-md-4 py-4">
  <div class="px-3 py-5">
      <div class="row mb-3">
          <h1 class="m-0">Barangay Certificate of Indigency</h1>
          <hr>
      </div>
      <div class="row mx-0">
          ...
          <section class="inner-content col-md-9 p-0 bg-transparent rounded" style="overflow: hidden;">
            <form method="POST" class="needs-validation" id="barangay-clearance-form" class="px-3 py-4" novalidate action="<?= ACTIONS_URL ?>add-request-barangay-certificate-of-indigency.php" enctype="multipart/form-data">
                <div class="card mb-4">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Barangay Certificate of Indigency</h5>
                ...
                <div class="ff-courier row m-0 a4" id="barangay-certificate-printable">
                    ...
                    <div class="col-9">
                        <div class="text-center">
                            ...
                            <h4 class="my-4 fw-bold">BARANGAY CERTIFICATE OF INDIGENCY</h4>
                        </div>
                        <p style="text-indent: 50px; text-align: justify;" class="mb-4">
                            This is to certify that <u class="text-uppercase" id="certificate-resident-name-prefix"><?= $name_prefix ?></u> <u class="text-uppercase" id="certificate-resident-name"><?= $requester_full_name ?></u>, <u class="text-uppercase" id="certificate-resident-age">born on <?= $requester_date_of_birth ?> (<?= $requester_age ?></u> years old), 
                            ...
                            <span class="text-uppercase" id="certificate-resident-province">Bulacan</span> is one of the poorest residents of this barangay.
                        </p>
                        <p>
                        <span class="mt-2 mb-0" style="text-align: justify;">
                            <span style="margin-left: 50px;"></span>  This certification is being issued upon the request of the above-named person for <u id="certificate_purpose_placeholder" class="text-danger text-nowrap"><?= $requester_purpose ?></u> and for whatever legal purpose it may serve her/his best, and is valid for six (6) months from the date issued. 
                        </span>
                        </p>
