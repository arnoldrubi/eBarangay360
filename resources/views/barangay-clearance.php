<?php
  ...
  if(isset($_GET['request_id']) && $_GET['success'] == 1) {
     ...
     $stmt = $pdo->prepare("
       ...
       FROM residents r
       JOIN barangay_clearance_requests bcr ON r.id = bcr.resident_id
  ...
  <div class="px-3 py-5">
      ...
      <div class="row mx-0">
          ...
          <section class="inner-content col-md-9 p-0 bg-transparent rounded" style="overflow: hidden;">
            <form method="POST" class="needs-validation" id="barangay-clearance-form" class="px-3 py-4" novalidate action="<?= ACTIONS_URL ?>add-request-barangay-clearance.php" enctype="multipart/form-data">
                <div class="card mb-4">
                ...
                <div class="ff-courier row m-0 a4" id="barangay-certificate-printable">
                    ...
                    <div class="col-9">
                        <div class="text-center">
                            ...
                            <h4 class="my-4 fw-bold">BARANGAY CLEARANCE</h4>
                        </div>
