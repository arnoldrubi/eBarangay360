...
try {
  $stmt = $pdo->prepare("
    INSERT INTO barangay_indigency_requests (resident_id, purpose, status, requested_at)
  ...
  header("Location: ../../public/index.php?page=barangay-certificate-of-indigency&success=1&request_id=" . $latestRequest);
  exit;
