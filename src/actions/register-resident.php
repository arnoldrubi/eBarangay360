...
$stmt = $pdo->prepare("
  INSERT INTO residents (
    ...
    alive, valid_id_type, valid_id_number, photo_filename, created_at, unemployed, reg_status, registration_source
  ) VALUES (
    :fname, :mname, :lname,
    ...
    :alive, :idtype, :idnum, :photo, :created_at, :unemployed, :reg_status, :registration_source
  )
");
